/*
 * $Id: main3.cpp,v 1.4 2006/12/27 09:34:58 wangjp2 Exp $
...
int build_action(sodict_build_t *sdb)
{
    ...
    while(1) {
        ...
        printf("4. search a node in the dictionary, please select 4 or s\n");
        ...
        printf("7. load object dictionary from files, please select 7 or L\n");
        ...
        switch(type[0]) {
            ...
            case '7':   
                        ...
                        printf("please enter dictionary name: ");
                        fscanf(stdin, "%s", name);
                        printf("load dictionary object to file ./%s ... \t", name);
                        sdb = odb_load("./", name, 0);
